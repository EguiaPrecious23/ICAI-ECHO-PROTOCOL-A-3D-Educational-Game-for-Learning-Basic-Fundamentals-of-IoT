...
public class ItemSlotTwoLED : MonoBehaviour, IDropHandler
{
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        DragDropTwoLED draggedItem = eventData.pointerDrag?.GetComponent<DragDropTwoLED>();
